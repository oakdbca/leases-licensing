    ...
    <div>
        ...
        <FormSection :formCollapse="false" label="Proponent Reference Number" Index="proponent_reference_number"
            ...
            <BootstrapAlert v-if="!is_internal">
                <ul class="list-group">
                    <li class="list-group-item">You may use this field to identify the application within your
                        organisation (or for your own records).</li>
                    <li class="list-group-item">If entered, it will be displayed on any invoices generated by our system.
                    </li>
                </ul>
            </BootstrapAlert>
            <div class="row mb-3">
                <div class="col-sm-4">
                    <label class="" for="proponent_reference">Proponent Reference Number</label>
                </div>
                <div class="col-sm-8">
                    <input type="text" class="form-control" id="proponent_reference" name="proponent_reference"
                        v-model="proposal.proponent_reference_number" :readonly="is_internal || readonly" />
                </div>
            </div>
        </FormSection>
    </div>
