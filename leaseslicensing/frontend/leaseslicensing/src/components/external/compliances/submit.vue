<template lang="html">
    <div class="container">
        <div class="row">
            <div class="col-9">
                <div v-if="compliance && compliance.id" class="col border rounded p-3">
                    ...
                    <div class="my-4">
                        ...
                        <p>The compliance will be provided to an officer to assess.</p>
                        <p>You will be notified by email once your submission has been reviewed or if further
                            action is required</p>
                    </div>
                    <a class="btn btn-secondary" href="/external/">Back to dashboard</a>
                </div>
...
export default {
    ...
    methods: {
        fetchCompliance: async function (compliance_id) {
            let vm = this;
            const response = await fetch(helpers.add_endpoint_json(api_endpoints.compliances, compliance_id));
