<template>
    <div id="userInfo" :class="classCompute">
        <div class="col-sm-12">
                        ...
                        <div :id="pBody" class="card-body collapse in">
                            ...
                            >
                                <alert
                                    ...
                                    style="color: red"
                                >
                                    <div v-for="item in errorListPersonal">
                                        <strong>{{ item }}</strong>
                                    </div>
                                </alert>
                                ...
                                <div class="row form-group">
                                    ...
                                    <div
                                        ref="dobDatePicker"
                                        class="col-sm-3 input-group date"
                                    >
                                        <input
                                            v-model="profile.dob"
                                            :disabled="dobReadOnly"
                                            type="text"
                                            class="form-control text-left ml-1"
                                            placeholder="DD/MM/YYYY"
                                        />
                                        <span class="input-group-addon">
                                            <span
                                                class="glyphicon glyphicon-calendar ml-1"
                                            ></span>
                                        </span>
                                    </div>
                                </div>
                        ...
                        >
                            ...
                            >
                                <alert
                                    ...
                                    style="color: red"
                                >
                                    <div v-for="item in errorListAddress">
                                        <strong>{{ item }}</strong>
                                    </div>
                                </alert>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input
                                                ...
                                                v-model="
                                                    profile.postal_same_as_residential
                                                "
                                                :readonly="readonly"
                                                type="checkbox"
                                            />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input
                                                id="postal_line1"
                                                v-model="
                                                    profile.postal_address.line1
                                                "
                                                :readonly="
                                                    postalAddressReadonly
                                                "
                                                type="text"
                                                class="form-control"
                                                name="Street"
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card card-default">
                        ...
                        <div :id="cBody" class="card-body collapse">
                            <form
                                class="form-horizontal"
                                action="index.html"
                                method="post"
                            >
                                <alert
                                    ...
                                    style="color: red"
                                >
                                    <div v-for="item in errorListContact">
                                        <strong>{{ item }}</strong>
                                    </div>
                                </alert>
                                <div class="form-group">
            ...
            <FormSection
                v-if="showElectoralRoll"
                label="WA State Electoral Roll"
                :index="electoralRollSectionIndex"
            >
                <div class="form-group">
                    <div class="col-sm-8 mb-3">
                        <strong>
                            You must be on the WA state electoral roll to make
                            an application
                        </strong>
                    </div>
                    <div class="col-sm-8">
                        <input
                            id="electoral_roll_yes"
                        ...
                        <label for="electoral_roll_yes">
                            ...
                            <a
                                href="/"
                                @click.prevent="uploadProofElectoralRoll"
                                >WA state electoral roll</a
                            >
                        </label>
                    </div>
                    <div class="col-sm-8">
                        <input
                            id="electoral_roll_silent"
                            v-model="silentElector"
                            :disabled="readonly"
                            class="mb-3"
                            type="radio"
                        ...
                        <div v-if="silentElector === true">
                            <FileField
                                ...
                                :is-repeatable="true"
                                :document-action-url="electoralRollDocumentUrl"
        ...
        orgConsultRequest: function () {
            ...
            for (var organisation in vm.profile.leaseslicensing_organisations) {
                if (
                    ...
                    vm.profile.leaseslicensing_organisations[organisation]
