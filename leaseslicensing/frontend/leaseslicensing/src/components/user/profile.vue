        ...
        <div class="col-sm-12">
                ...
                <div class="col-sm-12">
                    <div class="well well-sm">
                        <div class="row">
                            <div class="col-sm-12">
                                <p>
                                    We have detected that this is the first time you have logged into the system.Please take
                                    a moment to provide us with your details
                                    (personal details, address details, contact details, and whether you are managing
                                    licences for an organisation).
                ...
                <div class="col-sm-12">
                    <div class="card card-default">
                        <div class="card-header">
                            <i v-if="showCompletion && profile.personal_details" class="fa fa-check fa-2x pull-left"
                                style="color:green"></i>
                            <i v-else-if="showCompletion && !profile.personal_details" class="fa fa-times fa-2x pull-left"
                                style="color:red"></i>
                        ...
                        <div class="card-body collapse in" :id="pBody">
                            <form class="form-horizontal" name="personal_form" method="post">
                                <alert v-if="showPersonalError" type="danger" style="color:red">
                                    <div v-for="item in errorListPersonal"><strong>{{ item }}</strong></div>
                                </alert>
                                <div class="form-group">
                                    <label for="" class="col-sm-3 control-label">Given name(s)</label>
                                    <div class="col-sm-6">
                                        <input :readonly="firstNameReadOnly" type="text" class="form-control"
                                            id="first_name" name="Given name" placeholder="" v-model="profile.first_name"
                                            required="">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input :readonly="lastNameReadOnly" type="text" class="form-control" id="surname"
                                            name="Surname" placeholder="" v-model="profile.last_name">
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <label for="" class="col-sm-3 control-label">Date of Birth</label>
                                    <div class="col-sm-3 input-group date" ref="dobDatePicker">
                                        <input :disabled="dobReadOnly" type="text" class="form-control text-left ml-1"
                                            placeholder="DD/MM/YYYY" v-model="profile.dob" />
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="card card-default">
                        <div class="card-header">
                            <i v-if="showCompletion && profile.address_details" class="fa fa-check fa-2x pull-left"
                                style="color:green"></i>
                            <i v-else-if="showCompletion && !profile.address_details" class="fa fa-times fa-2x pull-left"
                                style="color:red"></i>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input :readonly="readonly" type="text" class="form-control" id="line1"
                                                name="Street" placeholder="" v-model="profile.residential_address.line1">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <input :readonly="readonly" type="text" class="form-control" id="state"
                                                name="State" placeholder="" v-model="profile.residential_address.state">
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input :readonly="postalAddressReadonly" type="text" class="form-control"
                                                ...
                                                v-model="profile.postal_address.line1">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Town/Suburb</label>
                                        <div class="col-sm-6">
                                            <input :readonly="postalAddressReadonly" type="text" class="form-control"
                                                ...
                                                v-model="profile.postal_address.locality">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">State</label>
                                        <div class="col-sm-3">
                                            <input :readonly="postalAddressReadonly" type="text" class="form-control"
                                                ...
                                                v-model="profile.postal_address.state">
                                        </div>
                                        <label for="" class="col-sm-1 control-label">Postcode</label>
                                        <div class="col-sm-2">
                                            <input :readonly="postalAddressReadonly" type="text" class="form-control"
                                                id="postal_postcode" name="Postcode" placeholder=""
                                                v-model="profile.postal_address.postcode">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Country</label>
                                        <div class="col-sm-4">
                                            <select :disabled="postalAddressReadonly" class="form-control"
                                                id="postal_country" name="Country" v-model="profile.postal_address.country">
                                                <!--option v-for="c in countries" :value="c.alpha2Code">{{ c.name }}</option-->
                                                <option v-for="c in countries" :value="c.code">{{ c.name }}</option>
                                            </select>
                                        </div>
                        ...
                        <div class="card-body collapse" :id="cBody">
                            <form class="form-horizontal" action="index.html" method="post">
                                <alert v-if="showContactError" type="danger" style="color:red">
                                    <div v-for="item in errorListContact"><strong>{{ item }}</strong></div>
                                </alert>
                                <div class="form-group">
                                    <label for="" class="col-sm-3 control-label">Phone (work)</label>
                                    <div v-if="profile.is_internal" class="col-sm-6">
                                        <input :readonly="phoneNumberReadonly || readonly" type="text" class="form-control"
                                            id="phone" name="Phone" placeholder="" v-model="profile.phone_number">
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div v-if="profile.is_internal" class="col-sm-6">
                                        <input :readonly="mobileNumberReadonly || readonly" type="text" class="form-control"
                                            id="mobile" name="Mobile" placeholder="" v-model="profile.mobile_number">
                                    </div>
                                    <div v-else class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <input :readonly="emailReadOnly" type="email" class="form-control" id="email"
                                            name="Email" placeholder="" v-model="profile.email">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div v-if="!readonly" class="col-sm-12">
            ...
            <FormSection v-if="showElectoralRoll" label="WA State Electoral Roll" :Index="electoralRollSectionIndex">
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input :disabled="readonly" class="mb-3" type="radio" id="electoral_roll_silent" :value="true"
                            v-model="silentElector" />
                        ...
                        <div v-if="silentElector === true">
                            <FileField :readonly="readonly" headerCSS="ml-3" label="Provide evidence"
                                ref="electoral_roll_documents" name="electoral-roll-documents" :isRepeatable="true"
                                :documentActionUrl="electoralRollDocumentUrl" :replace_button_by_text="true" />
                        </div>
                    </div>
                </div>
            </FormSection>
