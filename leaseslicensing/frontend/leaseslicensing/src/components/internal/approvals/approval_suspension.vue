                        ...
                        <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group date" ref="from_date" style="width: 70%;">
                                            <input type="text" class="form-control" name="from_date"
                                                placeholder="DD/MM/YYYY" v-model="approval.from_date">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea name="suspension_details" class="form-control" style="width:70%;"
                                            v-model="approval.suspension_details"></textarea>
                                    </div>
                                </div>
                            </div>
